...
# 1. Setup Paths (Pointing to your EBS volume)
BASE_DIR = "/mnt/ml-data"
DATA_PATH = os.path.join(BASE_DIR, "datasets/raw.csv")
MODEL_DIR = os.path.join(BASE_DIR, "models")
LOG_DIR = os.path.join(BASE_DIR, "logs")

print("Loading data from EBS volume...")
# The UCI Adult dataset usually doesn't have a header
columns = ["age", "workclass", "fnlwgt", "education", "education-num", "marital-status", 
           "occupation", "relationship", "race", "sex", "capital-gain", "capital-loss", 
           "hours-per-week", "native-country", "income"]

# 2. Load and Preprocess Data [cite: 85, 89]
...
# 3. Feature Scaling [cite: 89]
scaler = StandardScaler()
X_train_scaled = scaler.fit_transform(X_train)
X_test_scaled = scaler.transform(X_test)

# 4. Train Two Models [cite: 91]
...
# 5. Select Best Model Automatically [cite: 93]
if acc1 > acc2:
...
# 6. Save Model and Log Metrics to EBS [cite: 94, 96, 97, 98]
